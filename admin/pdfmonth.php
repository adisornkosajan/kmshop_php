...
$pdf->Cell(59	,5,iconv( 'UTF-8','TIS-620','ยอดประจำเดือน'),0,1);//end of line
...
$pdf->Cell(25	,5,iconv( 'UTF-8','TIS-620','เดือน'),0,0);
...
$pdf->Cell(155	,5,iconv( 'UTF-8','TIS-620','เดือน'),1,0);
